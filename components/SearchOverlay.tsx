    ...
    <AnimatePresence>
      {searchOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-[80] bg-warm-white overflow-y-auto"
        >
          <div className="max-w-[800px] mx-auto px-6 pt-24 pb-12 relative">
            ...
            <motion.div 
              ...
              className="flex items-center border-b-2 border-ink pb-3 mb-12 gap-4"
            >
              ...
              <input
                ...
                className="flex-1 font-display text-2xl sm:text-3xl lg:text-4xl font-light text-ink bg-transparent outline-none placeholder-stone/50"
              />
              {query && (
