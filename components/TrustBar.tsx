...
export default function TrustBar() {
  const items = [
    { icon: "⭐", label: "4.9 / 5", value: "2,400+ Homes" },
    { icon: "🚚", label: "Free Delivery", value: "Above ₹50,000" },
    { icon: "🛡️", label: "5-Year Warranty", value: "Every Piece" },
    { icon: "📞", label: "Complimentary", value: "Design Consultation" },
  ];
