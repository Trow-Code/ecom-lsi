...
export default function ShopByRoom() {
  ...
  return (
    <section id="rooms" className="py-24 lg:py-28 bg-[#FAF8F5]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-12 lg:px-20 xl:px-24">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12 sm:mb-16">
          ...
          <div className="max-w-xs">
            <p className="font-sans text-xs sm:text-sm text-muted font-light leading-relaxed tracking-wide">
        ...
        <div className="flex flex-col lg:flex-row h-[520px] lg:h-[620px] gap-5">
          {ROOMS.map((room) => {
            ...
            return (
              <a
                key={room.id}
                href={`/categories/${pathMap[room.id]}`}
              ...
              >
                ...
                <div className="absolute inset-0 flex items-end p-6 sm:p-8 z-10">
                  <div className="flex flex-col">
                    <span className="font-sans text-[9px] tracking-widest uppercase text-[#C49A5D] mb-1 sm:mb-2 font-semibold">
